# Brief Station — 2026-08-05 06:45 (Paris)

## 🔴 ALERTES
- 25_convergence_basis: esp20 -1.09 < borne -0.90 -> COUPER LE BOT
...
| 25_convergence_basis | ROUGE | 518 | -0.2136 | -3.15 | -110.65 | -11.408 | 9.7 j |
...
**P&L paper cumule (hors temoin)** : -436.35 $

**BTC** 64153 $ — ret 1j +0.13% · 7j +0.30% · 30j +0.15%
**Moves 24h ≥ 20 %** : SKR +44.4%, CASHCAT +32.2%

# Brief Station — 2026-08-05 07:01 (Paris)

## 🔴 ALERTES
- 25_convergence_basis: esp20 -1.03 < borne -0.90 -> COUPER LE BOT
...
| 25_convergence_basis | ROUGE | 519 | -0.2137 | -3.16 | -110.91 | -11.434 | 9.7 j |
...
**P&L paper cumule (hors temoin)** : -436.61 $

**BTC** 64150 $ — ret 1j +0.13% · 7j +0.29% · 30j +0.15%
**Moves 24h ≥ 20 %** : SKR +45.6%, CASHCAT +34.2%

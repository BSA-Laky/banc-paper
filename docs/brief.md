# Brief Station — 2026-08-17 01:30 (Paris)
...
| 29b_carry_neutre_large | GRIS | 20 | 1.3233 | 0.78 | 26.47 | 2.342 | 11.3 j |
| 29c_carry_decale | ORANGE | 60 | -0.1279 | -0.95 | -7.68 | -0.685 | 11.2 j |
| rd_h2 | ORANGE | 133 | -0.0081 | -0.02 | -1.08 | -0.05 | 21.4 j |

### 🛑 Bots arretes / tues (11) — retires du banc, statistiques figees
| Bot | Statut | n | esp | t | P&L $ | P&L/j | fwd |
|---|---|---|---|---|---|---|---|
| 24_funding_multivenues | ROUGE | 171 | -0.5092 | -3.3 | -87.07 | -1.606 | 54.2 j |
| 25_convergence_basis | ROUGE | 546 | -0.2221 | -3.4 | -121.24 | -5.639 | 21.5 j |
| 27a_rev_premium | ROUGE | 82 | -1.6268 | -0.67 | -133.4 | -2.466 | 54.1 j |
| 27b_rev_move | ROUGE | 97 | 1.07 | 0.63 | 103.79 | 1.933 | 53.7 j |
| 27c_mom_move | ROUGE | 97 | -1.21 | -0.71 | -117.37 | -2.186 | 53.7 j |
| 27d_rev_move_stop | ROUGE | 157 | -0.8065 | -0.73 | -126.63 | -2.633 | 48.1 j |
| 27e_arbitre | ROUGE | 30 | -1.0046 | -0.4 | -30.14 | -0.68 | 44.3 j |
| 27f10_selecteur | ROUGE | 175 | -0.0665 | -0.09 | -11.64 | -0.269 | 43.3 j |
| 27f_selecteur | ROUGE | 71 | 0.1566 | 0.08 | 11.12 | 0.257 | 43.3 j |
...
**BTC** 62815 $ — ret 1j -0.38% · 7j -3.16% · 30j -1.74%

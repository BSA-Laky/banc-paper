# Brief Station — 2026-08-05 07:45 (Paris)

## 🔴 ALERTES
- **BANC SUSPECT** : un temoin a |t| >= 2 — ne rien conclure.
- 25_convergence_basis: esp20 -0.93 < borne -0.90 -> COUPER LE BOT
...
| 25_convergence_basis | ROUGE | 521 | -0.2138 | -3.17 | -111.37 | -11.482 | 9.7 j |
...
**P&L paper cumule (hors temoin)** : -437.13 $

**BTC** 64332 $ — ret 1j +0.41% · 7j +0.58% · 30j +0.43%
**Moves 24h ≥ 20 %** : SKR +45.5%, CASHCAT +29.8%

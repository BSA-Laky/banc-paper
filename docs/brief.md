# Brief Station — 2026-08-05 16:45 (Paris)
...
| 25_convergence_basis | ROUGE | 546 | -0.2221 | -3.4 | -121.24 | -12.004 | 10.1 j |
| 27a_rev_premium | ORANGE | 53 | -2.27 | -1.0 | -120.31 | -2.818 | 42.7 j |
| 27b_rev_move | ORANGE | 68 | 1.754 | 0.89 | 119.27 | 2.813 | 42.4 j |
| 27c_mom_move | ORANGE | 68 | -1.894 | -0.96 | -128.79 | -3.038 | 42.4 j |
| 27d_rev_move_stop | ORANGE | 94 | -0.5055 | -0.35 | -47.51 | -1.295 | 36.7 j |
| 27e_arbitre | ROUGE | 30 | -1.0046 | -0.4 | -30.14 | -0.913 | 33.0 j |
| 27f10_selecteur | ORANGE | 174 | 0.0331 | 0.04 | 5.76 | 0.181 | 31.9 j |
| 27f_selecteur | ORANGE | 47 | -0.8845 | -0.37 | -41.57 | -1.303 | 31.9 j |
| 27g10_selecteur | ROUGE | 41 | 0.3552 | 0.17 | 14.56 | 0.602 | 24.2 j |
| 28_carry_hold | GRIS | 16 | -4.0572 | -0.65 | -64.92 | -6.624 | 9.8 j |
| 29_carry_neutre | GRIS | 6 | -4.1776 | -0.54 | -25.07 | -2.558 | 9.8 j |
| rd_h2 | ORANGE | 126 | 0.2148 | 0.71 | 27.06 | 2.706 | 10.0 j |

**P&L paper cumule (hors temoin)** : -499.97 $

**BTC** 64380 $ — ret 1j +0.49% · 7j +0.65% · 30j +0.51%
**Moves 24h ≥ 20 %** : CASHCAT +32.4%, SKR +21.7%

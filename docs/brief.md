# Brief Station — 2026-07-31 09:01 (Paris)
...
|---|---|---|---|---|---|---|---|
| 24_funding_multivenues | ROUGE | 171 | -0.5092 | -3.3 | -87.07 | -2.322 | 37.5 j |
| 25_convergence_basis | ORANGE | 186 | -0.0115 | -0.09 | -2.14 | -0.445 | 4.8 j |
| 27a_rev_premium | ORANGE | 44 | -1.0937 | -0.47 | -48.12 | -1.287 | 37.4 j |
...
| rd_h2 | ORANGE | 59 | 0.3742 | 0.75 | 22.08 | 4.698 | 4.7 j |

**P&L paper cumule (hors temoin)** : -124.56 $

**BTC** 64179 $ — ret 1j -0.89% · 7j +0.09% · 30j +6.95%

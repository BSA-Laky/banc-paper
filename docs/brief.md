# Brief Station — 2026-08-06 12:45 (Paris)
...
| 27b_rev_move | ORANGE | 70 | 1.2829 | 0.64 | 89.8 | 2.079 | 43.2 j |
| 27c_mom_move | ORANGE | 70 | -1.4229 | -0.71 | -99.6 | -2.306 | 43.2 j |
...
| 28_carry_hold | GRIS | 18 | -3.345 | -0.61 | -60.21 | -5.68 | 10.6 j |
| 29_carry_neutre | GRIS | 6 | -4.1776 | -0.54 | -25.07 | -2.365 | 10.6 j |
| rd_h2 | ORANGE | 133 | -0.0081 | -0.02 | -1.08 | -0.099 | 10.9 j |

**P&L paper cumule (hors temoin)** : -557.87 $

**BTC** 64588 $ — ret 1j -0.06% · 7j -0.26% · 30j +1.95%
**Moves 24h ≥ 20 %** : CASHCAT +37.1%

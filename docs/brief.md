# Brief Station — 2026-08-06 21:55 (Paris)
...
| 25_convergence_basis | ROUGE | 546 | -0.2221 | -3.4 | -121.24 | -10.73 | 11.3 j |
| 27a_rev_premium | ORANGE | 56 | -2.8459 | -1.29 | -159.37 | -3.622 | 44.0 j |
| 27b_rev_move | ORANGE | 70 | 1.2829 | 0.64 | 89.8 | 2.06 | 43.6 j |
| 27c_mom_move | ORANGE | 70 | -1.4229 | -0.71 | -99.6 | -2.284 | 43.6 j |
| 27d_rev_move_stop | ORANGE | 103 | -1.09 | -0.8 | -112.27 | -2.954 | 38.0 j |
| 27e_arbitre | ROUGE | 30 | -1.0046 | -0.4 | -30.14 | -0.881 | 34.2 j |
| 27f10_selecteur | ROUGE | 175 | -0.0665 | -0.09 | -11.64 | -0.352 | 33.1 j |
| 27f_selecteur | ORANGE | 49 | -0.2543 | -0.1 | -12.46 | -0.376 | 33.1 j |
| 27g10_selecteur | ROUGE | 41 | 0.3552 | 0.17 | 14.56 | 0.573 | 25.4 j |
| 28_carry_hold | GRIS | 21 | -3.085 | -0.65 | -64.78 | -5.89 | 11.0 j |
| 29_carry_neutre | GRIS | 6 | -4.1776 | -0.54 | -25.07 | -2.279 | 11.0 j |
| rd_h2 | ORANGE | 133 | -0.0081 | -0.02 | -1.08 | -0.096 | 11.2 j |

**P&L paper cumule (hors temoin)** : -620.36 $

**BTC** 64430 $ — ret 1j -0.30% · 7j -0.50% · 30j +1.70%
**Moves 24h ≥ 20 %** : ACE +56.3%
